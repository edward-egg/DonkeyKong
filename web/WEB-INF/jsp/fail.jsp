                ...
                <div class="main-content">
                    <div class="row">
                        <div class="col-twelve">
                            <h1 class="kern-this">Error Input.</h1>
                            <p>
                ...
                <footer>
                    <div class="row">
                        <div class="col-five tab-full bottom-links">
                            <ul class="links">
                                <li><a href="redirect/main">Homepage</a></li>
                                <li><a href="redirect/login">Login</a></li>
                                <li><a href="redirect/register">Register</a></li>			                    
                            </ul>
                        </div>   		   		
                    </div> <!-- /row -->    		  		
                </footer>
