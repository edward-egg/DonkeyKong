                ...
                <div class="detail">
                    ...
                    <div id="tab2" class="write-note">
                        <form action="note/add" method="POST" onsubmit="document.characterSet = 'utf8'">
                            ...
                            <div>
                                <input id="n-pic" name="source" hidden="true" />
                            </div>
                            <div id="note-sub" class="note-submit">
                                <button class="note-sub" type="submit">Submit</button>
                                <button class="btn-upload" type="button">Upload Image</button>
                            </div>

                            <div class="upload-dialog" title="Choose Note Image">
                                    <div class="choose">
                                        <img id="upload-dialog" style="width: 130px;height: 130px;display: block;margin: 0 auto;" src="resource/imags/note/" title="choose the image" alt=""/>
    ...
    <script>
                            ...
                            $(function () {
                                ...
                                $('.upload-dialog').dialog({
                                    ...
                                    buttons:{
                                        "Submit":function(){
                                            $("#n-pic").attr("value",$("#upload-dialog").attr("src"));
                                            $(this).dialog("close");
                                        },
                                        "Cancel":function(){
                                            $("#upload-dialog").attr("src","");
                                            $("#select-avatar").attr("value","");
                                            $("#n-pic").attr("value","");
                                            $(this).dialog("close");
                                        }
                                    }
                            ...
                            function bindAvatar() {
                                $('#select-avatar').change(function () {
                                    ...
                                    fr.onload = function () {
                                        $('#upload-dialog').attr('src', this.result);
                                    };
