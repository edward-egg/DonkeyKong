                        ...
                        <table>
                            <tr>
                                ...
                                <td class="unfinish text" style="display: none">
                                    <input type="text" class="id" readonly="true"  name="userId"  value="<%=user.getUserId()%>" />
                                </td>                              
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="unfinish text" style="display: none">
                                    <input type="text" class="tel" name="tel"  value="<%=user.getTel()%>" />
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="unfinish text" style="display: none">
                                    <input type="text" class="email" name="email" value="<%=user.getEmail()%>" />
                                </td>
                            </tr>
                        </table>
                                            ...
                                            $('.save').click(function (check) {
                                                ...
                                                if (tval == "") {
                                                    ...
                                                    if (!telRegex.test(tval)) {
                                                        $.edbox({warning:'Invalid Tel!'});
                                                        $('.tel').focus();
                                                        check.preventDefault();
                                                    } 
                                                else if (mval != null)
                                                    if (!mailRegex.test(mval)) {
                                                        $.edbox({warning:'Invalid Email!'});
                                                        $('.email').focus();
                                                        check.preventDefault();
                                                    } 
                                                else{
