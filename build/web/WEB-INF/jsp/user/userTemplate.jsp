        ...
        <div class="banner">
            <nav>
                <ul id="tabs">
                    <li>
                        <a href="toUserDetail">
                            <img src="resource/imags/icon/menu.png" class="icon-menu" alt="" />My Infomation</a>
                    </li>
                    <li>
                        <a href="toMyNote">
                            <img src="resource/imags/icon/menu.png" class="icon-menu" alt="" />My Note</a>
                    </li>
                    <li>
                        <a href="toGoTravel">
                            <img src="resource/imags/icon/menu.png" class="icon-menu" alt="" />Tour</a>
                    </li>
                    <li>
                        <a href="toHotelBooking">
                            <img src="resource/imags/icon/menu.png" class="icon-menu" alt="" />Hotel Book</a>
                    </li>
                </ul>
            </nav>
        </div>
